...
function minheap_extract(heap) {
    ...
    while ((left_index < heap.length && heap[current_index].priority > heap[left_index].priority) || 
        ...
        if ((left_index < heap.length && right_index < heap.length) && heap[left_index].priority > heap[right_index].priority) {
            index = right_index;
        }

        if (index < heap.length && heap[current_index].priority > heap[index].priority && index < heap.length) {
            let temp = heap[current_index];
